...
const projects = [
  {
    title: 'Live Docs',
    description:
      'Real-time collaborative document editor built with Next.js, TypeScript, and Tailwind CSS, featuring live editing, comments, and notifications.',
    image: project1,
  ...
  },
  {
    title: 'Figma Clone',
    description:
      'A real-time collaborative design tool inspired by Figma. This application allows users to create, modify, and collaborate on designs in real-time.',
    image: project2,
  ...
  },
  {
    ...
    description:
      'React-based chatbot clone of Google Gemini AI. It offers a chat interface, uses Gemini for responses, and is styled with CSS.',
    image: project4,
  ...
  },
  {
    title: 'Travel App',
    description:
      'Travel App is a React web application offering travel information, built with Tailwind CSS for a modular, responsive user interface.',
    image: project5,
  ...
  },
  {
    ...
    description:
      'A modern AI application built with React JS and Tailwind CSS, featuring smooth animations, unique design elements, and responsive layouts.',
    image: project6,
